...
return {
  {
    ...
    config = function()
      ...
      local opts = {
        ...
        sections = {
          lualine_a = { modes },
          lualine_b = { pyenv, space },
          lualine_c = { branch, filetype, diff, space, filename, location },
          lualine_x = { macro },
          lualine_y = { { "overseer", color = { bg = colors.gray2, fg = colors.blue, gui = "bold" } } },
          lualine_z = { dia, lsp, scrollbar },
        },
      }
